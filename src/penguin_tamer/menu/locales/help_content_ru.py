...
автоматически применяться к каждому вашему запросу к LLM. Обратите внимание, что основная информация о вашем рабочем окружении уже есть в распоряжении модели:
