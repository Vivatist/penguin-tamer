...
- **Множество провайдеров ИИ** - Поддержка OpenAI, OpenRouter, DeepSeek, Anthropic и других распространенных провайдеров
...
- 💡 **Идеи** - Буду рад любым идеям по улучшению и развитию Ai-eBash
