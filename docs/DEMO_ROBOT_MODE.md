...
### 3. Последовательное воспроизведение
...
2. Выдержит паузу 3-4 секунды (кроме первого действия)
3. Симулирует печать этого действия побуквенно
4. "Нажмёт Enter" (пауза 0.3 сек)
5. Обработает действие как обычный пользовательский ввод
6. Повторит для всех действий в записи
7. После завершения записи переключится в обычный режим диалога
